...
HD_PWD='E:/Semesters/FA22/VE370/Labs/Lab5/Lab5_lyf/Lab5_lyf.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipeline2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipeline2.tcl
